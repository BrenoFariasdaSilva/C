// Programa Instruções para cálculo do produto de 3 inteiros.
/*
...
a)//Programa para cálculo de 3 inteiros.
...
int main()
{
    ...
    c)printf:("Digite 3 numeros:");

    d)scanf("%d%d%d", &x, &y, &z);

    e)resultado = (x *y * z);

    f)printf("O produto é %d", resultado);
