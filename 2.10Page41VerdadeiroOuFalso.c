...
RESPOSTA:
a) Falso. o operador igual (=) é avaliado da direita pra esquerda.

b) Verdadeiro.

c) Falso. Este instrução apenas mostra a mensagem na tela para o usuário. -> a = 5;

d) Verdadeiro.

e)Falso. Nomes de variáveis não podem começar com números.
